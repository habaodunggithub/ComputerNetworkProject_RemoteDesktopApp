document.addEventListener('DOMContentLoaded', () => {
    ...
    function onWsMessage(event) {
        ...
        switch (msg.type) {
            ...
            case 'help': $('#help-content').textContent = msg.commands.join('\n'); break;
            case 'status':
                if (msg.success) {
    ...
    function handleKeyEvent(keyCode) {
        ...
        function translateKeyCode(code) {
            ...
            switch (code) {
                ...
                case 19: return '[Pause]'; case 20: return '[CapsLk]'; case 27: return '[Esc]';
                case 32: return '[Space]'; case 33: return '[PgUp]'; case 34: return '[PgDn]';
                case 35: return '[End]'; case 36: return '[Home]'; case 37: return '[Left]';
                case 38: return '[Up]'; case 39: return '[Right]'; case 40: return '[Down]';
                case 44: return '[PrtSc]'; case 45: return '[Insert]'; case 46: return '[Delete]';
                case 106: return '[Num *]'; case 107: return '[Num +]'; case 109: return '[Num -]';
                case 110: return '[Num .]'; case 111: return '[Num /]'; case 144: return '[NumLock]';
                ...
                case 162: case 163: return '[LCtrl]'; case 164: return '[LAlt]'; case 165: return '[RAlt]';
                case 186: return ';'; case 187: return '='; case 188: return ','; case 189: return '-';
                case 190: return '.'; case 191: return '/'; case 192: return '`';
                case 219: return '['; case 220: return '\\'; case 221: return ']'; case 222: return "'";
                case 91: return '[LWin]'; case 92: return '[RWin]'; case 93: return '[Menu]';
                default: return `[${code}]`;
            }
        }
    ...
    function handleWebcamVideo(b64) {
        ...
        } catch(e) { console.error(e); alert("Video decode error"); }
    }
    ...
    function showView(viewId) {
        ...
        $(`.nav-item[data-view="${target}"]`)?.classList.add('active');
    ...
    function init() {
        ...
        // Webcam
        btnStartRecord.onclick = () => { $('#modal-webcam-device').classList.remove('hidden'); $('#modal-backdrop').classList.remove('hidden'); };
        ...
        $('#btn-save-video').onclick = () => {
            if(currentVideoBlob) {
                const a = document.createElement('a'); a.href = URL.createObjectURL(currentVideoBlob); a.download = `webcam-${Date.now()}.mp4`; a.click();
            }
        };
        ...
        // Modals
        $('#btn-start-process').onclick = () => { $('#modal-start-process').classList.remove('hidden'); $('#modal-backdrop').classList.remove('hidden'); };
        $('#btn-start-app').onclick = () => { $('#modal-start-app').classList.remove('hidden'); $('#modal-backdrop').classList.remove('hidden'); };
        ...
        if(localStorage.getItem('theme')==='dark') { document.body.className = 'dark-theme'; $('#theme-toggle').checked = true; }
